...
public sealed class GitPullCommand(IServiceProvider provider) : AsyncCommand
{
    public override async Task<int> ExecuteAsync(CommandContext context, CancellationToken cancellationToken)
    {
        ...
        var result = await runner.RunAsync("pull");
        ...
        {
            AnsiConsole.MarkupLine($"[red]git pull failed:[/] {Markup.Escape(result.StandardError)}");
        }
